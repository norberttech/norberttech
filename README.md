...
- [coduo/php-matcher](https://github.com/coduo/php-matcher) ([6.0.5](https://github.com/coduo/php-matcher/releases/tag/6.0.5), 6 days ago) - The easiest way to match data structures like JSON/PlainText/XML against readable patterns. Sandbox:
